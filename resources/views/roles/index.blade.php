               ...
               <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{route('roles.edit', $roles->id) }}" class="btn btn-primary">Permission</a>
                        </td>
                        <td>
                            <a href="{{route('roles.edit', $roles->id) }}" class="btn btn-warning">Edit</a>
                        </td>
                        <td>
                            <form id="deleteForm{{$roles->id}}" action="{{ route('roles.destroy', $roles->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                            <button data-form="deleteForm{{$roles->id}}" type="button" class="btn btn-danger btn-delete">Delete</button>
                        </td>
                    </tr>
