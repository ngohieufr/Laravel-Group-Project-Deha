 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="index.html">
          <i class="zmdi zmdi-view-dashboard"></i> <span><a href="">Users</a></span>
        </a>
      </li>
...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top">
  <ul class="navbar-nav mr-auto align-items-center">
    ...
    <li class="nav-item">
      <form class="search-bar" action="{{ route('users.index') }}" method="GET" id="search-form">
          <div class="input-group">
              <input type="text" class="form-control" name="search" placeholder="Enter keywords" value="{{ request('search') }}">
...
<div class="clearfix"></div>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          @else
                            <a class="btn btn-warning">Access Denied</a>
                          @endcan
                        </td>
                        <td>
                            ...
                            @can('delete', $user)
                            <button data-form="deleteForm{{$user->id}}" type="button" class="btn btn-danger btn-delete">Delete</button>
                            @else 
  ...
  <script>
    ...
    document.getElementById("search-form").addEventListener("submit", function(event) {
        ...
        if (searchInput) {
            // Hiển thị div chứa kết quả tìm kiếm
            document.getElementById("search-results").style.display = "block";
        } else {
            // Nếu không có từ khóa, ẩn div kết quả
